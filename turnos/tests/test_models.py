...
class TestModelos:
    ...
    def test_usuario_str(self):
        ...
        usuario = UsuarioFactory.crear_usuario(
            'PACIENTE', '12345678-9', 'juan_str', '123',
            'Juan', 'Pérez', 'jp@cl.cl'
        )
    ...
    def test_bloque_hora_inicio_mayor_a_fin_falla(self):
        ...
        medico = UsuarioFactory.crear_usuario('MEDICO', '88888888-8', 'dr_test_mod', '123', 'M', 'A', 'm@cl.cl')
    ...
    def test_bloque_superposicion_falla(self):
        """Dos bloques superpuestos deben lanzar ValidationError (líneas 73-74)."""
        medico = UsuarioFactory.crear_usuario('MEDICO', '77777777-7', 'dr_sup', '123', 'Dr', 'Sup', 'sup@cl.cl')
    ...
    def test_bloque_str(self):
        ...
        medico = UsuarioFactory.crear_usuario('MEDICO', '66666666-6', 'dr_blk', '123', 'Ana', 'B', 'ana@cl.cl')
        ...
        bloque = BloqueDisponibilidad.objects.create(
            medico=medico, especialidad=esp,
            fecha=manana,
            hora_inicio=time(8, 0), hora_fin=time(8, 30)
        )
    ...
    def test_reserva_str(self):
        ...
        paciente = UsuarioFactory.crear_usuario('PACIENTE', '55555555-5', 'pac_str', '123', 'Carlos', 'R', 'cr@cl.cl')
        medico = UsuarioFactory.crear_usuario('MEDICO', '44444444-4', 'dr_res_str', '123', 'Dr', 'Z', 'drz@cl.cl')
        ...
        bloque = BloqueDisponibilidad.objects.create(
            medico=medico, especialidad=esp,
            fecha=manana,
            hora_inicio=time(14, 0), hora_fin=time(14, 30)
        )
        reserva = Reserva.objects.create(paciente=paciente, bloque=bloque, estado='RESERVADO')
